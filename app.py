...
def next_turn(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        canvas.delete("food")  # Correctly delete the food
...
window.geometry(f"{window_width}x{window_height}+{x}+{y}".format(window_width, window_height, x, y))
